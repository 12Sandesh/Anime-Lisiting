...
// Check if the user has added the manga to their list / status of the manga for the user
...
// Check if the user has added the manga to favorites
if (isset($_SESSION['userID'])) {
...
// Manga score and number of members
