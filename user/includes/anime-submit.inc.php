...
if (isset($_POST['add-submit'])) {
    if (isset($_SESSION['userID'])) {
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
            ...
            if ($resultCheck > 0) {
                header("Location: ../php/anime.php?animeid=" . $animeID);
            } else {
...
if (isset($_POST['favorite-submit'])) {
    ...
    if (!mysqli_stmt_prepare($stmt, $sql)) {
        ...
        $resultCheck = mysqli_num_rows($result);
        if ($resultCheck > 0) {
            echo 'You have already added this anime to your favorites';
        } else {
            ...
            if (!mysqli_stmt_prepare($stmt, $sql)) {
                ...
                $resultCheck = mysqli_num_rows($result);
                if ($resultCheck >= 10) {
                    echo 'You already have more than 10 favorites in your list';
                } else {
...
// User's episodes watched for the anime
