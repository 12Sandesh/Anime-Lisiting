...
// Check if the user has added the anime to their list and their status for the anime
...
// Check if the user has added the anime to their favorites
if (isset($_SESSION['userID'])) {
...
// Anime score and number of members
