...
<head>
    <title>Comments by <?php echo $userAllCommentsName; ?> - AnimeKoji</title>
    <meta charset="UTF-8">
            ...
            <div class="comments">
                ...
                <div class="page-buttons-top">
                    ...
                    if ($page <= $total_pages && $page != 1) {
                        echo '<a href="all-comments.php?userid=' . $userID . '&page=' . $pagePrevious . '" class="page-button">Previous</a>';
                    }
                    if ($page < $total_pages) {
                        echo '<a href="all-comments.php?userid=' . $userID . '&page=' . $pageNext . '" class="page-button">Next</a>';
                    }
                    ?>
                </div>

                <?php
                echo '<h3>Comments on ' . $userAllCommentsName . '\'s profile</h3>';
                if ($resultCheckComment > 0) {
                    ...
                    echo '<div class="not-comment">This profile has no comments</div>';
                }
                ?>
